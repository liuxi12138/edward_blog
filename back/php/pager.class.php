...
//数据库查询的偏移量
                ...
                private function pre_page() {
                        if ($this->page_id() == 1) { //页数等于1
                                return "<a href=".$this->php_self()."?page_id=1".$this->url()."><button class=\"left-btn\">&#59229;</button></a>";
                        }elseif ($this->page_id() != 1) { //页数不等于1
                                return "<a href=".$this->php_self()."?page_id=".($this->page_id()-1).$this->url()."><button class=\"left-btn\">&#59229;</button></a>";
                        }
                }
 ...
 return $display_page;
                ...
                private function next_page() {
                        if ($this->page_id() < $this->page_num()) { //页数小于总页数
                                return "<a href=".$this->php_self()."?page_id=".($this->page_id()+1).$this->url()."><button class=\"right-btn\">&#59230;</button></a>";
                        }elseif ($this->page_id() == $this->page_num()) { //页数等于总页数
                                return "<a href=".$this->php_self()."?page_id=".$this->page_num().$this->url()."><button class=\"right-btn\">&#59230;</button></a>";
                        }
                }
