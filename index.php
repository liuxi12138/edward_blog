...
?>
    ...
    <p class="autor">
        ...
        <span>分类：【
            <a target="_blank" href="category.php?id=<?php echo $row['categoryId']?>"><?php echo $row['categoryName']?></a>
        】</span>
...
?>
  ...
  <aside>
    <div class="avatar"><a href="http://www.iliuye.com/Wap/Index/article/id/82202"><span>关于萧逸</span></a></div>
